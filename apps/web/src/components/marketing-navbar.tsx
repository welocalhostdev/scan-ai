...
export function MarketingNavbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/20 bg-[#080808] text-white">
      <div className="grid h-[76px] grid-cols-[1fr_auto] border-b border-white/0 min-[1440px]:grid-cols-[minmax(260px,0.48fr)_1fr_minmax(300px,0.48fr)]">
        <div className="flex items-center border-white/18 px-5 min-[1440px]:border-r min-[1440px]:px-14">
        ...
        <nav className="hidden items-center justify-center gap-10 min-[1440px]:flex">
          {navItems.map((item) => (
        ...
        <div className="hidden items-center justify-end gap-8 border-l border-white/18 px-14 min-[1440px]:flex">
          {loading ? (
        ...
        <button
          ...
          className="flex h-[76px] w-[76px] items-center justify-center border-l border-white/18 text-white min-[1440px]:hidden"
      ...
      {mobileOpen && (
        <div className="border-t border-white/18 bg-[#080808] px-5 py-5 min-[1440px]:hidden">
